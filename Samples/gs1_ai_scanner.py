...
if __name__ == '__main__':
    ...
    if error_code != EnumErrorCode.EC_OK and error_code != EnumErrorCode.EC_LICENSE_WARNING:
        ...
        template_path = BASE_DIR.parent / "CustomTemplates" / "ReadGS1AIBarcode.json"
        errorCode, errorMsg = cvr_instance.init_settings_from_file(str(template_path))
        ...
        while (True):
            ...
            if image_path == "":
                image_path = str(BASE_DIR.parent / "Images" / "gs1-ai-sample.png")
